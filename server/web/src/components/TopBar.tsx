...
export function TopBar({ onMenuClick, onSearch, themeMode, onToggleTheme, username }: TopBarProps): JSX.Element {
  const searchRef = React.useRef<TextFieldElement>(null);
